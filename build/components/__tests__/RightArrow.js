...
describe('<RightArrow />', function () {
  it('Should render a <div> tag', function () {
    var renderedComponent = shallow(_react["default"].createElement(_RightArrow["default"], null));
  ...
  it('Should adopt a valid attribute', function () {
    var id = 'test-id';
    var renderedComponent = shallow(_react["default"].createElement(_RightArrow["default"], {
      id: id
    }));
